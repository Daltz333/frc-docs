...
- Verifying that your robot works in :doc:`Simulation </docs/software/wpilib-tools/robot-simulation/introduction/introduction>` is also a great way to prevent having to do complex debugging on the actual robot.
